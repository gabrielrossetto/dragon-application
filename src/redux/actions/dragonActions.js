...
export const getDragonSuccess = dragon => ({ type: GET_DRAGON_SUCCESS, payload: dragon })
...
export const postDragonSuccess = dragon => ({ type: POST_DRAGON_SUCCESS, payload: dragon })
...
export const deleteDragonSuccess = dragon => ({ type: DELETE_DRAGON_SUCCESS, payload: dragon })
export const deleteDragonFailure = () => ({ type: DELETE_DRAGON_FAILURE })

export const EDIT_DRAGON = 'EDIT_DRAGON'
export const EDIT_DRAGON_SUCCESS = 'EDIT_DRAGON_SUCCESS'
export const EDIT_DRAGON_FAILURE = 'EDIT_DRAGON_FAILURE'
export const editDragon = () => ({ type: EDIT_DRAGON })
export const editDragonSuccess = dragon => ({ type: EDIT_DRAGON_SUCCESS, payload: dragon })
export const editDragonFailure = () => ({ type: EDIT_DRAGON_FAILURE })
...
export function updateDragon(dragon) {
  return async dispatch => {
    ...
    try {
      ...
      dispatch(editDragonSuccess(data))
    } catch (error) {
      dispatch(editDragonFailure())
    }
  }
}
